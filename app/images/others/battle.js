 ...
 */var
    ...
    Pokemon = function () {
                                                                                    ...
                                                                                    hasMovestatus = function hasMovestatus(volatile) {
                                                                                        ...
                                                                                        clearMovestatuses = function clearMovestatuses() {
                                                                                            ...
                                                                                            clearVolatiles = function clearVolatiles() {
                                                                                                ...
                                                                                                rememberMove = function rememberMove(moveName) {
                                                                                                    var pp = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1; var recursionSource = arguments.length > 2 ? arguments[2] : undefined;
                                                                                                    ...
                                                                                                    if (this.volatiles.transform) {
                                                                                                        ...
                                                                                                        this.moveTrack; _i < _this$moveTrack.length; _i++) {
                                                                                                                                                    ...
                                                                                                                                                    getBaseSpecies = function getBaseSpecies() {
                                                                                                                                                        ...
                                                                                                                                                        reset = function reset() {
                                                                                                                                                            ...
                                                                                                                                                            hpWidth = function hpWidth(maxWidth) {
                                                                                                                                                                ...
                                                                                                                                                                getHPText = function getHPText(pokemon) {
        ...
        Side = function () {
            ...
            this.name = ''; this.id = ''; this.foe = null; this.avatar = 'unknown'; this.rating = ''; this.totalPokemon = 6; this.x = 0; this.y = 0; this.z = 0; this.missedPokemon = null; this.wisher = null; this.active = [null]; this.lastPokemon = null; this.pokemon = []; this.sideConditions = {};
                this.battle = battle;
                this.n = n;
                this.updateSprites();
                                                    ...
                                                    setName = function setName(name, avatar) {
                                                        ...
                                                        addSideCondition = function addSideCondition(effect) {
                                                            ...
                                                            removeSideCondition = function removeSideCondition(condition) {
                                                                ...
                                                                addPokemon = function addPokemon(name, ident, details) {
                                                                        ...
                                                                        if (toRemove >= 0) {
                                                                            if (this.pokemon[toRemove].fainted) {
                                                                                ...
                                                                                var illusionFound = null; for (var _i3 = 0, _this$pokemon2 =
                                                                                    this.pokemon; _i3 < _this$pokemon2.length; _i3++) {
                                                                                ...
                                                                                if (!illusionFound) {
                                                                                    for (var _i4 = 0, _this$pokemon3 =




                                                                                        this.pokemon; _i4 < _this$pokemon3.length; _i4++) {
                                                                    ...
                                                                    switchIn = function switchIn(pokemon, slot) {
                                                                        ...
                                                                        dragIn = function dragIn(pokemon) {
                                                                            ...
                                                                            replace = function replace(pokemon) {
                                                                                var slot = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : pokemon.slot;
                                                                                var oldpokemon = this.active[slot];
                                                                                ...
                                                                                switchOut = function switchOut(pokemon) {
                                                                                    var slot = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : pokemon.slot;
                        ...
                        removePseudoWeather = function removePseudoWeather(weather) {
                            ...
                            addPseudoWeather = function addPseudoWeather(weather, minTimeLeft, timeLeft) {
                                ...
                                hasPseudoWeather = function hasPseudoWeather(weather) {
                                    for (var _i5 = 0, _this$pseudoWeather =
                                        this.pseudoWeather; _i5 < _this$pseudoWeather.length; _i5++) {
                                            var _ref = _this$pseudoWeather[_i5]; var pseudoWeatherName = _ref[0];
                                    ...
                                    init = function init() {
                                        ...
                                        reset = function reset(dontResetSound) {
                                            ...
                                            this.lastMove = ''; for (var _i6 = 0, _this$sides =
                                                ...
                                                this.sides; _i6 < _this$sides.length; _i6++) {
                                                    var _side = _this$sides[_i6];
                                                                                    ...
                                                                                    setTurn = function setTurn(turnNum) {
                                                                                        ...
                                                                                        resetTurnsSinceMoved = function resetTurnsSinceMoved() {
                                                                                            ...
                                                                                            updateToxicTurns = function updateToxicTurns() {
                                                                                                for (var _i7 = 0, _this$sides2 =
                                                                                                    this.sides; _i7 < _this$sides2.length; _i7++) {
                                                                                                        var _side2 = _this$sides2[_i7]; for (var _i8 = 0, _side2$active =
                                                                                                            _side2.active; _i8 < _side2$active.length; _i8++) {
                                                                                                                var poke = _side2$active[_i8];
                                                                                                ...
                                                                                                changeWeather = function changeWeather(weatherName, poke, isUpkeep, ability) {
                                                                                                    ...
                                                                                                    updatePseudoWeatherLeft = function updatePseudoWeatherLeft() {
                                                                                                        for (var _i9 = 0, _this$pseudoWeather2 =
                                                                                                            this.pseudoWeather; _i9 < _this$pseudoWeather2.length; _i9++) {
                                                                                                                var pWeather = _this$pseudoWeather2[_i9];
                                                                                                            if (pWeather[1]) pWeather[1]--;
                                                                                                            if (pWeather[2]) pWeather[2]--;
                                                                                                        } for (var _i10 = 0, _this$sides3 =
                                                                                                            this.sides; _i10 < _this$sides3.length; _i10++) {
                                                                                                                var _side3 = _this$sides3[_i10];
                                                                                                        ...
                                                                                                        useMove = function useMove(pokemon, move, target, kwArgs) {
                                                                                                            ...
                                                                                                            if (fromeffect.id === 'sleeptalk') {
                                                                                                                ...
                                                                                                                var pp = 1;
                                                                                                                if (move.target === "all") {
                                                                                                                    for (var _i11 = 0, _pokemon$side$foe$act =
                                                                                                                        pokemon.side.foe.active; _i11 < _pokemon$side$foe$act.length; _i11++) {
                                                                                                                            var active = _pokemon$side$foe$act[_i11];
                                                                                                            ...
                                                                                                            animateMove = function animateMove(pokemon, move, target, kwArgs) {
                                                                                                                ...
                                                                                                                if (kwArgs.spread === '.') {
                                                                                                                    ...
                                                                                                                    for (var _i12 = 0, _kwArgs$spread$split =
                                                                                                                        kwArgs.spread.split(','); _i12 < _kwArgs$spread$split.length; _i12++) {
                                                                                                                            var hitTarget = _kwArgs$spread$split[_i12];
                                                                                                                ...
                                                                                                                cantUseMove = function cantUseMove(pokemon, effect, move, kwArgs) {
                                                                                                                    ...
                                                                                                                    activateAbility = function activateAbility(pokemon, effectOrName, isNotBase) {
                                                                                                                        ...
                                                                                                                        runMinor = function runMinor(args, kwArgs, nextArgs, nextKwargs) {
                                                                                                                            ...
                                                                                                                            switch (args[0]) {
                                                                                                                                    ...
                                                                                                                                    if (kwArgs.from) {
                                                                                                                                        ...
                                                                                                                                        switch (_effect.id) {
                                                                                                                                            case 'lunardance': for (var _i13 = 0, _poke$moveTrack =
                                                                                                                                                _poke.moveTrack; _i13 < _poke$moveTrack.length; _i13++) {
                                                                                                                                                    var trackedMove = _poke$moveTrack[_i13];
                                                                                                                                                trackedMove[1] = 0;
                                                                                                                                            }
                                                                                                                                ...
                                                                                                                                case '-copyboost': {
                                                                                                                                    ...
                                                                                                                                    if (this.gen >= 6) {
                                                                                                                                        var volatilesToCopy = ['focusenergy', 'laserfocus']; for (var _i16 = 0; _i16 <
                                                                                                                                            volatilesToCopy.length; _i16++) {
                                                                                                                                                var volatile = volatilesToCopy[_i16];
                                                                                                                                ...
                                                                                                                                case '-clearallboost': {
                                                                                                                                    var timeOffset = this.scene.timeOffset; for (var _i17 = 0, _this$sides4 =
                                                                                                                                        this.sides; _i17 < _this$sides4.length; _i17++) {
                                                                                                                                            var _side4 = _this$sides4[_i17]; for (var _i18 = 0, _side4$active =
                                                                                                                                                _side4.active; _i18 < _side4$active.length; _i18++) {
                                                                                                                                                    var active = _side4$active[_i18];
                                                                                                                                                if (active) {
                                                                                                                                                    active.boosts = {};
                                                                                                                                ...
                                                                                                                                case '-cureteam': {
                                                                                                                                    var _poke22 = this.getPokemon(args[1]); for (var _i19 = 0, _poke22$side$pokemon =
                                                                                                                                        _poke22.side.pokemon; _i19 < _poke22$side$pokemon.length; _i19++) {
                                                                                                                                            var _target2 = _poke22$side$pokemon[_i19];
                                                                                                                                        _target2.status = '';
                                                                                                                                ...
                                                                                                                                case '-transform': {
                                                                                                                                    ...
                                                                                                                                    _poke28.addVolatile('formechange', speciesForme); for (var _i20 = 0, _tpoke$moveTrack =
                                                                                                                                        tpoke.moveTrack; _i20 < _tpoke$moveTrack.length; _i20++) {
                                                                                                                                            var _trackedMove = _tpoke$moveTrack[_i20];
                                                                                                                                    ...
                                                                                                                                    switch (_effect17.id) {
                                                                                                                                        ...
                                                                                                                                        case 'feint':
                                                                                                                                            ...
                                                                                                                                            _poke35.removeTurnstatus('protect'); for (var _i21 = 0, _poke35$side$pokemon =
                                                                                                                                                _poke35.side.pokemon; _i21 < _poke35$side$pokemon.length; _i21++) {
                                                                                                                                                    var curTarget = _poke35$side$pokemon[_i21];
                                                                                                                                        ...
                                                                                                                                        case 'forewarn':
                                                                                                                                            if (_target3) {
                                                                                                                                                ...
                                                                                                                                                var foeActive = []; for (var _i22 = 0, _poke35$side$foe$acti =
                                                                                                                                                    _poke35.side.foe.active; _i22 < _poke35$side$foe$acti.length; _i22++) {
                                                                                                                                                        var maybeTarget = _poke35$side$foe$acti[_i22];
                                                                                                                                ...
                                                                                                                                case '-fieldstart': {
                                                                                                                                    ...
                                                                                                                                    switch (_effect21.id) {
                                                                                                                                        case 'gravity':
                                                                                                                                            if (!this.fastForward) {
                                                                                                                                                for (var _i23 = 0, _this$sides5 =
                                                                                                                                                    this.sides; _i23 < _this$sides5.length; _i23++) {
                                                                                                                                                        var _side7 = _this$sides5[_i23]; for (var _i24 = 0, _side7$active =
                                                                                                                                                            _side7.active; _i24 < _side7$active.length; _i24++) {
                                                                                                                                                                var _active = _side7$active[_i24];
                                                                                                                            ...
                                                                                                                            parseDetails = function parseDetails(name, pokemonid, details) {
                                                                                                                                            ...
                                                                                                                                            rememberTeamPreviewPokemon = function rememberTeamPreviewPokemon(sideid, details) {
                                                                                                                                                ...
                                                                                                                                                findCorrespondingPokemon = function findCorrespondingPokemon(serverPokemon) {
                                                                                                                                                    ...
                                                                                                                                                    var searchid = serverPokemon.ident + "|" + serverPokemon.details; for (var _i25 = 0, _this$sides$siden$pok =
                                                                                                                                                        this.sides[siden].pokemon; _i25 < _this$sides$siden$pok.length; _i25++) {
                                                                                                                                                            var _pokemon4 = _this$sides$siden$pok[_i25];
                                                                                                                                                    ...
                                                                                                                                                    getPokemon = function getPokemon(pokemonid) {
                                                                                                                                                        if (!pokemonid || pokemonid === '??' || pokemonid === 'null') return null; var _this$parsePokemonId4 =
                                                                                                                                                        ...
                                                                                                                                                        if (!isInactive && side.active[slot]) return side.active[slot]; for (var _i26 = 0, _side$pokemon =
                                                                                                                                                            side.pokemon; _i26 < _side$pokemon.length; _i26++) {
                                                                                                                                                                var _pokemon5 = _side$pokemon[_i26];
                                                                                                                                                                                        ...
                                                                                                                                                                                        skipTurn = function skipTurn() {
                                                                                                                                                                                            ...
                                                                                                                                                                                            fastForwardTo = function fastForwardTo(time) {
                                                                                                                                                                                                ...
                                                                                                                                                                                                fastForwardOff = function fastForwardOff() {
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    nextActivity = function nextActivity() {
                                                                                                                                                                                                        var _this = this;
